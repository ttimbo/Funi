Journey of survival in the year 2070 across the ruins of Rossgivo, a once vibrant and powerful European-like nation that existed for over a thousand years, brought down by the mysterious arrival of alien-like crusher organisms known as "Krushers" within 20 years, specifically in 2065 when its superior intelligence variants, Slammers and Gears, first appeared and had coordinated an attack that breached the frontlines.
...
**--EPISODE 1: STRONGHOLD FOX**
  ...
  **Introduces Rossgivo, what Krushers are, the purpose of Strongholds, references the Fall of Chinelo, and how people have adapted to living in Stronghold Fox for the past 5 years without any contact from the outside world.**
  ...
  What Krushers are is then hinted at, but the exact details are left vague (until Gavis explains it to Kinn during the Trac-a-nator scene.)
  ...
  _SCENE: ROSSGIVO FLAG_
   ...
   Although SST 6 has 3 inexperienced first-timers, Greg and Gavis both agree on cutting across a wide 6-lane road then moving through a nearby outdoor park on the other side surrounded by small-rise buildings on all sides, except for a sidewalk entrance that connects it to an adjacent parking lot _(which is already visible from SST 6's position in a nearby alleyway)_, then cutting through one of the buildings along the south side of the park.
   
   Greg informs HQ of their plan via radio, who accepts it, and each scout drone then flies over to one of two intersections that are on either end of that stretch of road, covering the blind spots they create for SST 6 to avoid the risk of a Krusher suddenly popping out from around a corner.
   ...
   Gavis, now somewhat disappointed by the others lack of understanding, asks Greg - the 2nd oldest member of SST 6, at 37 years old - if he understands the joke. Greg ponders for a bit, then asks if it means Krushers hate peace _(because the flag symbolises a transition into peace)_, since their current circumstance certainly aren't peaceful in the slightest, and Greg assumed it meant any instances were only the flag was damaged were Krushers trying to prove that point.
...
**--EPISODE 2: OLD ROSSGIVO**
  ...
  **Shows the nation of Rossgivo from the first appearance of Krushers in 2050, to the events leading up to and during the Fall of Chinelo in 2065, with a significant shift in public perception of Krushers over the years as more information about GCOs were gradually discovered.**
  
  **In the days before the Fall of Chinelo, there's a clear strong sense of optimism for the military as the Exclusion Zone had only minorly expanded in size during the past 15 years, especially with Rossgivo's thousand year long history of militaristic victories, and its 1000th anniversary being celebrated only a day prior.**
  
  **Throughout the episode, the original day-to-day lives of the main cast are shown, helping to explain their characters and personal goals.**
  
  The episode opens with Ruiz Kurnell, aged 3 since it's December 27, 2049 as dated by a nearby calendar, as he says goodbye to his dad as he's leaving their apartment to head back out on deployment to a military base in Northern Rossgivo.
  
  Ruiz's dad explains to his son that he isn't staying for New Years but that it was more important to make it back in time for Christmas, and promises to return in time for Ruiz's 4th birthday which in February.
  
  As Ruiz's dad is about to close the apartment door, it cuts to a similar shot of someone closing a locker door after they've put away their light green company uniform.
  
  It's now just past Midnight on January 15th, 2050 and in Northeastern Rossgivo, a college-aged blond man gets ready for his night shift as another older worker from the previous shift is about to leave for the night, shown by their casual clothing in contrast to the younger worker, whose wearing a full body light green uniform and cap with the company's logo.
  
  The older worker remarks on the current date, shown by a wall mounted digital clock, as its the 100 year anniversary of the _Civilian Revolution_, an event that established the current democratic country of Rossgivo after ousting its old dictatorship, which ravaged the country from war only a couple years prior from scarce resources, and further worsened by intensive bombing on its industrial sector.
  
  The older worker finds it odd that the day is still celebrated annually a century later, when almost everyone who lived through the old dictatorship is either dead or too young to remember, but as the younger worker points out that it's a national day of celebration rather than something only those older generations do, the older worker brushes it off as he's more concerned about getting back home.
  
  But as they're heading out the door, they remind the younger worker about a timetable for when he's supposed to call in to report since it's his first shift on the job - that being the Night Watch of privately owned forested campgrounds currently closed for the winter - though mostly just in case he wanted to sleep through much of his shift, since the older worker points that rarely anything ever happens, somewhat evident by its hourly wage apparently being barely above minimum wage.
  
  Afterwards, we see the first Krusher encounter occur near one of the campgrounds...
  
  A few hours into the young worker's shift, we see the first Krusher encounter occur near Campgrounds C, after its powerline somehow goes down during the calm, cloudy night but wasn't immediately noticed as it was already disabled for the winter and so didn't trigger an alarm, which the young worker sets out in one of the company's vehicles to investigate since he's stationed just down the road from the site.
  
  Yet, only as the worker begins to reach Campgrounds C does he notice the powerlines beginning to sag leading up to collapsed powerlines within the site, but more importantly, a small building apart of the campgrounds which looked just fine during his job orientation a few days prior, laid utterly destroyed other than for its concrete foundations.
  
  As the worker looks around, he notices that there's strangely hardly any rubble from the building besides for one of its face which has significant rubble, but most of the building seems to have somehow disappeared...
