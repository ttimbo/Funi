...
**--EPISODE 1: STRONGHOLD FOX**
  ...
  **Introduces Rossgivo, what Krushers are, the purpose of Strongholds, and how people adapted to living inside Stronghold Fox for 5 years without any contact from the outside world following the Fall of Chinelo—The surrounding city which was an important logistical hub for the previous frontlines.**
  
  The episode opens with an aerial wide shot of a large abandoned city with _Netherlands-style_ architecture, left to the elements for years, as the setting sun creates a reddish evening sky.
  ...
  SST 1 and their general position is brought to attention by a _civilian drone_ that flies above them, controlled by one of its members, _Dave Harris_, an autistic 24 year old Caucasian man with short trimmed brown hair, a small beard, who wears glasses to correct his nearsightedness.
  
  The drone has a dedicated controller with a built-in display, showing an aerial view of SST 1's surroundings through a small camera on the underside of the drone, and had an antenna attached onto it that allowed it to be used, given the presence of a _No Internet_ icon in the top right of the display, however it appears to be part of the factory design rather than a modification.
  
  A brief exchange between Dave and Ruiz tells us that SST 1 is using the drone to look out for _something_, however it's only described as being absent from their surroundings, since there'd be no reason for them to specify further because of its context.
  
  But presumably, Dave's referring to "_Krushers_" which are shown in the thumbnail: They have large red rectangular bodies, several metres in height, and about the width of a two-lane street, something that'd make them _rather conspicuous_ even if partially obscured by the environment.
  
  Also, the man in the military uniform standing off against the Krusher is _Ruiz Kurnell_.
  
  _Ruiz Kurnell_, a 24 year old Caucasian man with short brown hair wearing a grey camo military uniform with triangular insignias labeled "_40_", carefully peeks out from the alleyway SST 1 had been walking through, and looks both ways down the narrow two-lane street it leads out into, which he confirms as "_All Clear_" before quickly running across into a nearby pedestrian street, with the rest of SST 1 following behind him.
  ---
  This, paired with Dave's interaction with Ruiz, indicates that Ruiz is the group's Leader.
  ...
  ---
  The pedestrian street is lined with storefronts and a partially setup yet highly decorated festival, which a poster hung just outside the street explains as being a celebration of the 1000 year anniversary of "_Rossgivo_": A fictional European nation similar in size and location to the Holy Roman Empire, which had existed since 1065, and has a long history of militaristic achievements and victories; As is explained by a number of pamphlets and papers strewn along the street, handouts that were knocked over from their neat stacks by the wind at some point.
  
  Despite the festival being meant for nearby residents, it would've still been quite elaborate as shown by the considerable number of tables, even if most of them were left empty or couldn't be fully setup in time - The potential reason for which isn't expanded upon, but seems to have been from an apocalyptic event that occurred at about the same time as Rossgivo's anniversary.
  
  Soon after, Ruiz spots and walks over to a small family-owned convenience store with what appears to be a 2 floor apartment above it, which he attempts to open the front door of but finds it to be locked.
