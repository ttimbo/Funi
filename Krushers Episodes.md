...
**--EPISODE 1: STRONGHOLD FOX**
  ...
  **Introduces Rossgivo, what Krushers are, the purpose of Strongholds, references the Fall of Chinelo, and how people have adapted to living in Stronghold Fox for the past 5 years without any contact from the outside world.**
  ...
  The episode opens with an aerial wide shot of desolate, post-apocalyptic ruins of a large city with _Netherlands-style_ architecture, which appears to have been abandoned and left to the natural elements for many years, as the setting sun creates a reddish evening sky.
  
  Far from the city's urban centre, moving within its western outskirts, _initially appears_ to be a group of 6 wandering survivors, _Survey & Scavenging Team 1_, or SST 1, whose partaking on their _18th Expedition_ out from Stronghold Fox in an attempt to reach the suspected _New Frontlines_, which were most likely constructed to contain the breach of the previous frontlines _5 years prior_, an event that left them _stranded_ in Stronghold Fox with _no contact_ from the Outside World.
  
  SST 1 and their general position is brought to attention by a _civilian drone_ flying above them, which as expected, is being controlled by one of its members, _Dave_, a 24 year Caucasian man with short combed brown hair, whose autistic and wears glasses to correct his nearsightedness.
  
  Dave controls the drone through a small, dedicated controller with a built-in display which shows an aerial view of the surrounding environment from above, a tool that they're apparently using to look out for _something_ but it's only described as being absent from their surroundings.
  
  _Ruiz Kurnell_, a 24 year old Caucasian man with short brown hair, whose wearing a grey camo military uniform with triangular insignias labeled "_40_", carefully peeks out from the alleyway they've been walking through and looks both ways down the standard but narrow two-lane street it leads out into, which he confirms as "_All Clear_" before quickly running across into a nearby pedestrian street Dave had briefly mentioned beforehand, with the rest of SST 1 following behind Ruiz, indicating that he's the Leader.
  
  However, Ruiz lacks any other military equipment, his uniform is battered with visible repair work done through additional stitching, and his overall behavior and treatment from the others shows that he's in the same predicament as them.
  
  The pedestrian street is lined with storefronts and a partially setup yet highly decorated festival, which a couple posters hung just outside the street explain as being a celebration of the 1000 year anniversary of "_Rossgivo_", a fictional European nation similar in size and location to the Holy Roman Empire, which had existed since 1065, and has a long history of militaristic achievements and victories; As is explained by the number of pamphlets strewn along the street, most likely having been knocked over from their neat stacks by the wind at some point.
  
  Though the festival was likely meant for nearby residents as mentioned by one member, it would've still been quite elaborate given the considerable number of tables, even if most of them were left empty or couldn't be fully setup due to a sudden evacuation that the city could've been included in, however it's referred to as some sort of event that forced out the city's residents as one member speculates that they likely wouldn't have had enough time to fully setup the festival.
  
  Shortly after entering the pedestrian street, Ruiz spots and walks over to a small family-owned convenience store with what appears to be a 2 floor apartment above it.
  
  Ruiz tries to open its front door but finds it to be locked, and so he detracts his _Arm Blades_, a multi-bladed weapon on a large leather base strapped to Ruiz's right forearm, and uses it to break the front door's window using the tip of one of its blades, so he can open it from inside.
  ...
  _SCENE: STORE_
   ...
   Ruiz is wearing a large hiking backpack full of supplies and equipment, with 2 smoke grenades stored in its right side pocket for immediate access to distract Krushers with.
