...
**--EPISODE 1: STRONGHOLD FOX**
  ...
  **Introduces Rossgivo, what Krushers are, the purpose of Strongholds, references the Fall of Chinelo, and how people have adapted to living in Stronghold Fox for the past 5 years without any contact from the outside world.**
  ...
  The episode opens with a desolate almost post-apocalyptic Netherlands-style ruined city, as the setting sun creates a reddish sky.
  
  In its western outskirts, in a pedestrian street left undamaged by Krushers, there's remnants of a small partially setup but highly decorated festival, which a couple posters hung outside the street explain as being a celebration of the 1000 year anniversary of "_Rossgivo_", a fictional European country similar in size and location to the Holy Roman Empire, where the story takes place.
  
  Over in a nearby alleyway initially appears to be a group of 6 wandering survivors, _Survey & Scavenging Team 1 (SST 1)_, led by _Ruiz Kurnell_, a 24 year old man with short brown hair, whose wearing a grey camo military uniform with triangular insignias labeled "_40_", and a multi-bladed weapon with a large leather base strapped to his right forearm, referred to as "_Arm Blades_".
...
**--EPISODE 2: OLD ROSSGIVO**
  ...
  **Focuses on the original day-to-day lives of the main cast, helping to explain their characters and personal goals, alongside the nation of Rossgivo, and the gradual shift in perception of Krushers from their first appearance to the Fall of Chinelo, as more information was uncovered regarding GCOs over the years.**
  
  The episode opens with Ruiz Kurnell, aged 3 as it's sometime after Christmas in 2049, the year shown by a nearby calendar, saying goodbye to his dad as he's about to leave their apartment to head back out on deployment to a Rossgivian military base.
  
  Ruiz's dad explains to his son that he isn't staying for New Years but that it was more important to make it back for Christmas, then promises to return in time for Ruiz's 4th birthday which is coming up in February - Ruiz's dad being in the military is indicated by his wife, who mentions his constant "_deployment_" as he kisses her goodbye, despite the fact that _Rossgivo hadn't had any major involvement in warfare_ for the past century.
  
  As Ruiz's dad closes the apartment door, it cuts to a similar shot of someone closing a locker after they've put away their company uniform.
  
  
  It's now just past Midnight on _January 14th, 2050_ and in Northeastern Rossgivo, a college-aged blond worker sets up for his night shift as another older worker from the previous shift is about to leave for the night, indicated by their casual clothing in contrast to the younger worker, whose wearing a light green full body uniform and cap with the company's logo.
  
  Specifically, it's the Guard Watch of privately owned forested campgrounds currently closed for the winter, though since rarely anything noteworthy happens, its hourly wage is barely above minimum wage.
  
  The older worker remarks on the current date, shown by a wall mounted digital clock, as its the 100 year anniversary of the _Civilian Revolution_, an event that established the current democratic country of Rossgivo after ousting its old dictatorship, which ravaged the country from war only a couple years prior that left limited resources and food but was divided among the population by social status, further worsened by intensive bombing done on its industrial sector during the war which had gone largely unrecovered.
  ...
  The younger worker points out that it's a national day of celebration rather than something only those older generations do, but the older worker brushes it off as they're more concerned about getting back home, though not before reminding the younger worker as they're heading out the door about a timetable for when he's supposed to call in to report anything unusual, since it's his first shift on the job.
